...
public class MyTestFragment extends BaseFragment {
    ...
    public void splash(long time, int type) {
       ...
       SimpleDateFormat  formatTime=new SimpleDateFormat("yyyy-MM-dd");
        String endTime= formatTime.format(RecordActivity.getEndTime(time,mode));
        String stratTimeStr=formatTime.format(stratTime);
        String endTimeStr;
        String url=null;
        String urlParam="&Sort=Collectdate&CollectdateMin="+stratTimeStr+"&CollectdateMax="+endTime;
        switch (type) {
            case 0://体脂
