...
public abstract class BaseBegPermissionActivity extends BaseActivity {
    ...
    protected String[] begRWPermissons = {Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE};
    ...
    private void showGotoSetting(int requestCode) {
        ...
        CommonUtils.showButtonDialog(this, "未开启用户权限，去设置", "开启用户权限",
                clickOptionMap);
    }
